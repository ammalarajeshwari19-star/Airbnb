...
function ListingPage1(){
    ...
    return(
        <div className = 'w-[100vw] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
            
            <form action = "" className="max-w-[900px] w-[90%] h-[550px]
                    flex items-center justify-start flex-col
                    md:items-start gap-[10px] overflow-auto mt-[50px]" 
                    onSubmit={(e)=>{e.preventDefault()
                        ...
                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            ...
                            <textarea id = 'description'  className='w-[90%] h-[80px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]'required
                            onChange = {(e) => setDescription(e.target.value)} value = {description}></textarea>
                        </div>
                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            <label htmlFor="img1" className = 'text-[20px]'>Image1</label>
                            <div className = "flex-items-center justify-start w-[90%] h-[40px] border-2 border-[#555656] rounded-[10px] ">
                            <input type="file" id = 'img1'  className='w-[100%] text-[15px] px-[1f0px]'required 
                            onChange = {handleImage1}/></div>
                        </div>

                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            <label htmlFor="img2" className = 'text-[20px]'>Image2</label>
                            <div className = "flex-items-center justify-start w-[90%] h-[40px] border-2 border-[#555656] rounded-[10px]">
                            <input type="file" id = 'img2'  className='w-[100%] text-[15px] px-[1f0px]'required
                            onChange = {handleImage2}/></div>
                        </div>

                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            <label htmlFor="img3" className = 'text-[20px]'>Image3</label>
                            <div className = "flex-items-center justify-start w-[90%] h-[40px] border-2 border-[#555656] rounded-[10px]">
                            <input type="file" id = 'img3'  className='w-[100%] text-[15px] px-[1f0px]'required
                            onChange = {handleImage3}/></div>
                        </div>
                        ...
                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            ...
                            onChange = {(e) => setRent(e.target.value)} value = {rent} placeholder='Rs.____/day'/>
                        </div>
                        ...
                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            ...
                            onChange = {(e) => setCity(e.target.value)} value = {city} placeholder='city/country'/>
                        </div>

                        <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                            <label htmlFor="landmark" className = 'text-[20px]'>Landmark</label>
                            <input type="text" id = 'landmark'  className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]'required
                            onChange = {(e) => setLandmark(e.target.value)} value = {landmark} placeholder='Church,Bakery,Pole'/>
                        </div>
