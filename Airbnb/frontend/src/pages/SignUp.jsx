        ...
        <div className = 'w-[100vw] h-[100vh] flex items-center justify-center relative'>
            ...
            md:items-start gap-[10px]' onSubmit={handleSignUp}>
                ...
                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px] relative ' >
                    ...
                    {show && <IoEyeOff className = 'w-[22px] h-[22px] absolute right-[12%] bottom-[10px] cursor-pointer'onClick={()=>setShow(prev => !prev)}/>}
                </div>
                <button type="submit" className='px-[50px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg mt-[20px]' disabled={loading}>
                    {loading ? "Signing Up..." : "SignUp"}
                </button>
                <p className='text-[18px]'>Already have a aaccount?<span className='text-[19px] text-[red] cursor-pointer' onClick={()=>navigate("/login")}>Login</span></p>
            </form>
