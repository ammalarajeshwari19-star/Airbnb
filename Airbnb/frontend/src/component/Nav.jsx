    ...
    return(
        <div>
            <div className='w-[100vw] min-h-[80px] 
             border-b-[1px] border-[black] px-[40px] flex items-center
            ...
            <div className='w-[35%] relative hidden md:block'>
                ...
                <button className='absolute p-[10px] rounded-[50px]
                bg-[red] right-[3%] top-[5px]'><FiSearch className='w-[20px] h-[20px] text-[white]'/></button>
            </div>  
            ...
            gap-[10px] relative'>
                ...
                rounded-[50px] hover: shadow-lg 'onClick={()=>setShowpopup(prev =>!prev)}><span><GiHamburgerMenu 
                className='w-[20px] h-[20px] '/>
                </span>{userData == null && <span><CgProfile className='w-[23px] h-[23px]'/></span>}
                ...
                bg-slate-50 top-[110%] right-[3%] border-[1px]
                border-[#aaa9a9] z-10 rounded-lg md:right[10%]'>
                    <ul className='w-[100%] h-[100%] text-[17px] 
                    flex items-start justify-around 
                    flex-col py-[10px]'>
                        {!userData && <li className='w-[100%] px-[15px] py-[10px]
                        hover:bg-[#f4f3f3] cursor-pointer' onClick={()=> {navigate("/login"); 
                        setShowpopup(false)}}>Login</li>}
                        {userData && <li className='w-[100%] px-[15px] py-[10px]
                        hover:bg-[#f4f3f3] cursor-pointer'onClick={() =>{handleLogOut(); 
                        setShowpopup(false);}}>Logout</li>}
                        <div className='w-[100%] h-[1px] bg-[#c1c0c0]'></div>
                        <li className='w-[100%] px-[15px] py-[10px]
                        hover:bg-[#f4f3f3] cursor-pointer' onClick={()=>{navigate("/listingpage1"); setShowpopup(false);}}>List your Home</li>
                        <li className='w-[100%] px-[15px] py-[10px]
            ...
            <div className='w-[100%] h-[60px] bg-white flex 
            items-center justify-start cursor pointer gap-[40px] 
            overflow-auto md:justify-center px-[15px] block md:hidden'>
            ...
            justify-center cursor-pointer gap-[40px] overflow-auto'>
